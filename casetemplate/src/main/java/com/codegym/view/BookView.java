...
//    private Book [] books;
    ...
    public BookView(BookStore bookStore) {
        init();
    ...
    private void showMenuBookAdmin() {
    ...
    private void showMenuBookUser() {
        Scanner scan = new Scanner(System.in);
        boolean checkActionMenu = true;
        do {
            System.out.println("Menu quản lý sách: ");
            System.out.println("Nhấn 1. Xem danh sách");
            System.out.println("Nhấn 2. Sắp xếp sách theo giá ");
            System.out.println("Nhấn 3. Sắp xếp sách theo tên ");
            System.out.println("Nhấn 4. Tìm kiếm sách theo tên");
            System.out.println("Nhấn 5. Tìm kiếm sách theo tên hoặc mô tả");
            int actionMenu = Integer.parseInt(scan.nextLine());
            switch (actionMenu) {
                case 1:
                    showBooks();
